...
class Board():
    def __init__(self, entity:Entity, thickness:int=10, width:int=40, height:int=40, width_mul:bool=False) -> None:
        self.root = tk.Tk()
    ...
    def draw_entity(self):
        ...
        for member in self.entity.members:
            ...
            self.canvas.create_oval(member.x, member.y, member.x + width_, member.y + height_, fill=color)
...
ins = Board(Entity(50, True), 1, 10, 10, True)
ins.run()